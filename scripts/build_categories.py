...
# Amazon.in All → Shop by Category. Browse nodes checked against the live
# hamburger (nav_em_sbc_*) on 2026-08-14.
IN = market([
    dept('Mobiles, Computers', [
        ('All Mobile Phones', '1389401031'),
        ('Cases & Covers', '1389409031'),
        ('Screen Protectors', '1389425031'),
        ('Power Banks', '6612025031'),
        ('Refurbished Mobiles', '1805560031'),
        ('Tablets', '1375458031'),
        ('Wearable Devices', '11599648031'),
        ('Smart Home', '13773797031'),
        ('Laptops', '1375424031'),
        ('Drives & Storage', '1375393031'),
        ('Printers & Ink', '1375443031'),
        ('Networking Devices', '1375427031'),
        ('Computer Accessories', '1375248031'),
        ('Monitors', '1375425031'),
        ('Desktops', '1375392031'),
        ('Components', '1375344031'),
    ], '976392031'),
    dept('TV, Appliances, Electronics', [
        ('Televisions', '1389396031'),
        ('Home Entertainment Systems', '1389375031'),
        ('Headphones', '1388921031'),
        ('Speakers', '1389365031'),
        ('Home Audio & Theater', '1389387031'),
        ('Cameras', '1388977031'),
        ('Camera Accessories', '1388978031'),
        ('Security Cameras', '1389203031'),
        ('Air Conditioners', '3474656031'),
        ('Refrigerators', '1380365031'),
        ('Washing Machines', '1380369031'),
        ('Kitchen & Home Appliances', '4951860031'),
        ('All Appliances', '78695869031'),
    ], '976419031'),
    dept("Men's Fashion", [
        ('T-shirts & Polos', '1968120031'),
        ('Shirts', '1968093031'),
        ('Jeans', '1968076031'),
        ('Innerwear', '1968126031'),
        ('Watches', '2563504031'),
        ('Bags & Luggage', '2454169031'),
        ('Sunglasses', '1968036031'),
        ('Sportswear', '12456568031'),
        ('Shoes', '1983518031'),
    ], '7459781031'),
    dept("Women's Fashion", [
        ('Western Wear', '11400137031'),
        ('Ethnic Wear', '1968253031'),
        ('Lingerie & Nightwear', '11400136031'),
        ('Watches', '2563505031'),
        ('Handbags', '1983338031'),
        ('Gold & Diamond Jewellery', '5210069031'),
        ('Fashion Jewellery', '5210079031'),
        ('Sunglasses', '1968401031'),
        ('Sandals', '1983633031'),
    ], '7459780031'),
    dept('Home, Kitchen, Pets', [
        ('Kitchen & Dining', '5925789031'),
        ('Kitchen Storage', '1379989031'),
        ('Furniture', '1380441031'),
        ('Home Furnishing', '1380442031'),
        ('Home Improvement', '4286640031'),
        ('Garden & Outdoor', '2454175031'),
        ('Pet Supplies', '2454181031'),
        ('Home Decor', '1380374031'),
        ('Indoor Lighting', '1380485031'),
    ], '976442031'),
    dept('Beauty, Health, Grocery', [
        ...
        ('Household Supplies', '1374515031'),
        ('Nutrition & Wellness', '1374489031'),
        ('Health Care Devices', '3150028031'),
    ], '1355016031'),
    dept('Sports, Fitness, Bags, Luggage', [
        ('Cricket', '3403628031'),
        ('Badminton', '3403619031'),
        ('Cycling', '3403629031'),
        ('Exercise & Fitness', '3403925031'),
        ('Sports Shoes', '1983519031'),
        ('Backpacks', '2917430031'),
        ('Suitcases', '2917450031'),
        ('Travel Accessories', '2917434031'),
    ], '1984443031'),
    dept("Toys, Baby Products, Kids' Fashion", [
        ('Toys & Games', '1350380031'),
        ('Baby Products', '1571274031'),
        ('Diapers', '1953345031'),
        ('Baby Fashion', '11987349031'),
        ("Kids' Fashion", '9361420031'),
        ('STEM Toys', '9783607031'),
        ('Soft Toys', '1378445031'),
    ], '1350380031'),
    dept('Car, Motorbike, Industrial', [
        ('Car Accessories', '5257474031'),
        ('Car Electronics', '1389221031'),
        ('Car Parts', '5257475031'),
        ('Motorbike Accessories & Parts', '5257478031'),
        ('Industrial & Scientific', '5866078031'),
        ('Lab & Scientific', '6409335031'),
    ], '4772060031'),
    dept('Books', [
        ('All Books', '976389031'),
        ('Fiction', '1318157031'),
        ('Textbooks', '4149418031'),
        ('Kindle eBooks', '1634753031'),
        ("Children's Books", '1318073031'),
        ('Exam Central', '4149751031'),
    ], '976389031'),
    dept('Movies, Music & Video Games', [
        ('Movies', '976416031'),
        ('Music', '976445031'),
        ('Video Games', '976460031'),
        ('Gaming Consoles', '4092115031'),
        ('Gaming Accessories', '4092116031'),
    ], '976416031'),
])
...
US = market([
    ...
    dept('Software', [
        ('Accounting & Finance', '5223260011'),
        ('Antivirus & Security', '229677'),
        ('Business & Office', '229535'),
        ("Children's", '229548'),
        ('Design & Illustration', '229614'),
        ('Digital Software', '1233514011'),
        ('Education & Reference', '229563'),
        ('Games', '1294826011'),
        ('Lifestyle & Hobbies', '229624'),
        ('Music', '497022'),
        ('Photography & Graphic Design', '229621'),
        ('Programming & Web Development', '5223262011'),
    ...
    dept('Toys and Games', [
        ...
        ('Dress Up & Pretend Play', '166316011'),
        ('Kids Electronics', '166164011'),
        ('Games', '166220011'),
        ('Grown-Up Toys', '166263011'),
        ('Hobbies', '276729011'),
        ("Kids' Furniture, Décor & Storage", '166210011'),
        ...
        ('Stuffed Animals & Plush Toys', '166461011'),
        ('Toy Remote Control & Play Vehicles', '166508011'),
        ('Tricycles, Scooters & Wagons', '256994011'),
    ], '165793011'),
    dept('Video Games', [
...
DE = market([
    ...
    dept('Baby', [
        ('Baby Pflege', '3968859031'),
        ('Windeln', '3969092031'),
        ('Ernährung', '3968915031'),
        ('Kinderwagen', '3968953031'),
    ], '357577011'),
    dept('Spielzeug', [
